#### [unreleased]
* added `GitHub Languages` header for Language Pack updates. Language Pack updates can and will now be independent of the plugin release.
* added `class Language_Pack` and new repo, [Language Pack Maker](https://github.com/afragen/github-updater-language-pack-maker), to create and update from a separate Language Pack repository, only for GitHub at this time.
