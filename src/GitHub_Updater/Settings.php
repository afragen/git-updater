	...
	public function create_admin_page() {
		...
		<div class="wrap github-updater-settings">
			...
			<?php if ( 'github_updater_faq' === $tab ) : ?>
				...
				<p>
					<?php
						 printf(esc_html__('FAQs are actively under construction, for any other doubts refer to: %s, %s, %s', 'github-updater'),'<a href="https://github.com/afragen/github-updater/wiki" target="_blank">wiki</a>','<a href="https://github.com/afragen/github-updater/issues" target="_blank">github</a>',
			   ...
			   <li><a target="_blank"  href="https://github.com/afragen/github-updater/wiki/Extras-and-Credits">Extras and Credits</a></li>
				...
				<?php
					 printf(esc_html__('GHU is a free software release under the %s', 'github-updater'),
					 '<a href="https://github.com/afragen/github-updater/blob/master/LICENSE" target="_blank">"GNU General Public License v2.0"</a>');
				?>
				<br>
				<?php
					 printf(esc_html__('feel free to %s or %s to the plugin\'s author', 'github-updater'),
